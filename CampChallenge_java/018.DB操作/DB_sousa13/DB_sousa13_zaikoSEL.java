 ...
 * @author guest1Day
 */
public class DB_sousa13_zaikoSEL extends HttpServlet {
     ...
     */
        ...
        String product_Select = "SELECT * FROM product order by shouhin_ID";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("【 商品ID 】 " + db_data.getInt("shouhin_ID"));
            out.println("　　【 商品名 】　" + db_data.getString("shouhin_name"));
            out.println("　　【 在庫数 】　" + db_data.getString("shouhin_number"));
            out.println("　　【 価格 】　" + db_data.getInt("shouhin_price"));
            out.println("<br>");
