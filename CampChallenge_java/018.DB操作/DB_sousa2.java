 ...
 * @author guest1Day
 */
public class DB_sousa2 extends HttpServlet {
     ...
     */
        ...
        String profiles_Insert = "INSERT INTO profiles values(?,?,?,?,?)";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            db_st.setInt(1, 3);
            db_st.setString(2,"田中太郎");
            db_st.setString(3,"080-7890-1234");
            db_st.setInt(4, 25);
            db_st.setString(5, "1999-07-07");
