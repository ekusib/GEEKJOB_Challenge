 ...
 * @author guest1Day
 */
public class DB_sousa11_2 extends HttpServlet {
     ...
     */
        ...
        String profiles_Update = "UPDATE profiles SET name = ?, age = ?, tel = ?, birthday = ? WHERE profilesID = ?";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            db_st = db_con.prepareStatement(profiles_Update);
            ...
            db_st.setInt(4, birthday);
            db_st.setInt(5, profilesID );
            
            int i = db_st.executeUpdate();

            out.print("ID : " +profilesID + " の情報が以下に更新されました。<br><br>");
