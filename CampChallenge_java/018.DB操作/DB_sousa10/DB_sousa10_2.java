 ...
 * @author guest1Day
 */
public class DB_sousa10_2 extends HttpServlet {
     ...
     */
        ...
        String profiles_Delete = "DELETE FROM profiles WHERE profilesID = ?";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            db_st = db_con.prepareStatement(profiles_Delete);
            ...
            out.print("ID : " + profilesID + " の情報が消去されました。<br><br>");
