...
public final class insertconfirm_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(!hs.getAttribute("name").equals("") 
      ...
      if(hs.getAttribute("name").equals("")){
      out.write("\n");
      out.write("      <br><font color=\"red\">※名前が未入力です。</font>");

}     if(hs.getAttribute("year").equals("")||hs.getAttribute("month").equals("")||hs.getAttribute("day").equals("")){
      out.write("\n");
      out.write("      <br><font color=\"red\">※生年月日が未入力です。</font>");

}     if(hs.getAttribute("type") == null){
      out.write("\n");
      out.write("      <br><font color=\"red\">※種別が未入力です。</font>");
          
}     if(hs.getAttribute("tell").equals("")){
      out.write("\n");
      out.write("      <br><font color=\"red\">※電話番号が未入力です。</font>");

}     if(hs.getAttribute("comment").equals("")){
      out.write("\n");
      out.write("      <br><font color=\"red\">※自己紹介文が未入力です。</font>");

}
      out.write("\n");
      out.write("        <form action=\"insert\" method=\"POST\">\n");
      out.write("        <br> <input type=\"submit\" name=\"no\" value=\"登録画面に戻る\">\n");
      out.write("        </form>\n");
      out.write("        <br>\n");
      out.write("        ");
